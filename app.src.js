import { createClient } from 'https://esm.sh/@supabase/supabase-js@2';
  ...
  // Peer media frames arriving from the whatsapp-rust bridge.
  ...
  const SocialCallMediaAdapter = {
    ...
    initWs(){
      ...
      this.ws.onmessage = (e) => {
        // Binary frames are the whatsapp-rust bridge's RETURN media, tagged
        // exactly like the frames this adapter sends upward: 0x03 = peer PCM
        // audio, 0x04 = peer H.264 access unit. Text frames are the JSON
        // control/call_state messages as before.
